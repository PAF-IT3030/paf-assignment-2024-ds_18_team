    ...
    <div style={{ marginTop: "20px" }}>
      ...
      <section>
        <img
          ...
          src="https://media.istockphoto.com/id/925440650/photo/underwater-bubbles.jpg?s=612x612&w=0&k=20&c=k_iJkW8e2l7UdUvxRviAFanteIKgsOUYDkWtBrl8nzs="
          alt=""
        />
      </section>
      ...
      <section className="pl-6">
        ...
        <div>
          <div className="flex item-center">
            <h1 className="font-bold text-lg">Raam Kapoor</h1>
          </div>
          <h1 className="text-gray-500">@raamkapoor</h1>
        </div>
            ...
            <Box sx={{ borderBottom: 1, borderColor: "divider" }}>
              ...
              >
                <Tab
                  label="Posts"
                  value="1"
                  style={{ color: tabValue === "1" ? "#20207D" : "#6B7280" }}
                />
                <Tab
                  label="Workout Plans"
                  value="2"
                  style={{ color: tabValue === "2" ? "#20207D" : "#6B7280" }}
                />
                <Tab
                  label="Meal Plans"
                  value="3"
                  style={{ color: tabValue === "3" ? "#20207D" : "#6B7280" }}
                />
              </TabList>
            </Box>
            <TabPanel value="1">
