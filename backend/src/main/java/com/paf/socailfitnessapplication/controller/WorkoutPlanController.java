...
public class WorkoutPlanController {
    ...
    public ResponseEntity<WorkoutPlan> getWorkoutPlanById(@PathVariable String workoutPlanId) {
        Optional<WorkoutPlan> workoutPlans = workoutPlanService.getWorkoutPlanById(workoutPlanId);
    ...
    public ResponseEntity<WorkoutPlan> updateWorkout(@PathVariable String workoutPlanId,
            @RequestBody WorkoutPlan workoutPlan) {
        WorkoutPlan updatedWorkoutPlan = workoutPlanService.updateWorkoutPlan(workoutPlanId, workoutPlan);
